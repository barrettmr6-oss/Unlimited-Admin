if UA_LOADED and not _G.UA_DEBUG then
	-- error("Unlimited Admin is already running!", 0)
	return
end

pcall(function() getgenv().UA_LOADED = true end)
...
UAMouse = cloneref(Players.LocalPlayer:GetMouse())
...
-- xylex & europa
local iyassets = {
	["unlimitedadmin/assets/bindsandplugins.png"] = "rbxassetid://5147695474",
	["unlimitedadmin/assets/close.png"] = "rbxassetid://5054663650",
	["unlimitedadmin/assets/editaliases.png"] = "rbxassetid://5147488658",
	["unlimitedadmin/assets/editkeybinds.png"] = "rbxassetid://129697930",
	["unlimitedadmin/assets/edittheme.png"] = "rbxassetid://4911962991",
	["unlimitedadmin/assets/editwaypoints.png"] = "rbxassetid://5147488592",
	["unlimitedadmin/assets/imgstudiopluginlogo.png"] = "rbxassetid://4113050383",
	["unlimitedadmin/assets/logo.png"] = "rbxassetid://1352543873",
	["unlimitedadmin/assets/minimize.png"] = "rbxassetid://2406617031",
	["unlimitedadmin/assets/pin.png"] = "rbxassetid://6234691350",
	["unlimitedadmin/assets/reference.png"] = "rbxassetid://3523243755",
	["unlimitedadmin/assets/settings.png"] = "rbxassetid://1204397029"
}
...
if makefolder and isfolder and writefile and isfile then
	pcall(function() -- good executor trust
		...
		for _, folder in {"unlimitedadmin", "unlimitedadmin/assets"} do
		...
		for path in iyassets do
			if not isfile(path) then
				writefile(path, game:HttpGet((path:gsub("unlimitedadmin/", assets))))
			end
		end
		if IsOnMobile then writefile("unlimitedadmin/assets/.nomedia", "") end
	end)
end
...
Holder.Active = true
Holder.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
do
	...
	_corner.CornerRadius = UDim.new(0, 6)
	_corner.Parent = Holder
	local _stroke = Instance.new("UIStroke")
	_stroke.Color = Color3.fromRGB(80, 90, 160)
	_stroke.Thickness = 1.2
	_stroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
	_stroke.Parent = Holder
end

Title.Name = "Title"
Title.Parent = Holder
Title.Active = true
Title.BackgroundColor3 = Color3.fromRGB(55, 60, 140)
Title.BorderSizePixel = 0
Title.Size = UDim2.new(0, 250, 0, 20)
Title.Font = Enum.Font.SourceSansBold
Title.TextSize = 17
Title.Text = "Unlimited Admin FE v" .. currentVersion
...
Dark.Parent = Holder
Dark.Active = true
Dark.BackgroundColor3 = Color3.fromRGB(22, 24, 38)
...
Cmdbar.BackgroundColor3 = Color3.fromRGB(18, 20, 32)
Cmdbar.BackgroundTransparency = 0
Cmdbar.BorderSizePixel = 0
Cmdbar.Position = UDim2.new(0, 5, 0, 21)
...
Cmdbar.Text = ""
Cmdbar.ZIndex = 10
Cmdbar.PlaceholderText = "UA Command Bar"
Cmdbar.PlaceholderColor3 = Color3.fromRGB(120, 125, 170)

do
	local _corner = Instance.new("UICorner")
	_corner.CornerRadius = UDim.new(0, 4)
	_corner.Parent = Cmdbar
...
CMDsF.Position = UDim2.new(0, 5, 0, 46)
CMDsF.Size = UDim2.new(0, 245, 0, 174)
CMDsF.ScrollBarImageColor3 = Color3.fromRGB(80, 90, 150)
...
SettingsButton.Image = getcustomasset("unlimitedadmin/assets/settings.png")
...
ReferenceButton.Image = getcustomasset("unlimitedadmin/assets/reference.png")
ReferenceButton.ZIndex = 10

Settings.Name = "Settings"
Settings.Parent = Holder
Settings.Active = true
Settings.BackgroundColor3 = Color3.fromRGB(22, 24, 38)
...
SettingsHolder.ScrollBarImageColor3 = Color3.fromRGB(60, 65, 100)
...
Prefix.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
PrefixBox.BackgroundColor3 = Color3.fromRGB(60, 65, 100)
...
function makeSettingsButton(name,iconID,off)
	...
	button.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
ColorsButton = makeSettingsButton("Edit Theme",getcustomasset("unlimitedadmin/assets/edittheme.png"))
ColorsButton.Position = UDim2.new(0, 5, 0, 55)
ColorsButton.Size = UDim2.new(1, -10, 0, 25)
ColorsButton.Name = "Colors"
ColorsButton.Parent = SettingsHolder

Keybinds = makeSettingsButton("Edit Keybinds",getcustomasset("unlimitedadmin/assets/editkeybinds.png"))
Keybinds.Position = UDim2.new(0, 5, 0, 85)
Keybinds.Size = UDim2.new(1, -10, 0, 25)
Keybinds.Name = "Keybinds"
Keybinds.Parent = SettingsHolder

Aliases = makeSettingsButton("Edit Aliases",getcustomasset("unlimitedadmin/assets/editaliases.png"))
...
StayOpen.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Button.BackgroundColor3 = Color3.fromRGB(60, 65, 100)
Button.BorderSizePixel = 0
...
On.Name = "On"
On.Parent = Button
On.BackgroundColor3 = Color3.fromRGB(100, 120, 220)
...
Positions = makeSettingsButton("Edit/Goto Waypoints",getcustomasset("unlimitedadmin/assets/editwaypoints.png"))
Positions.Position = UDim2.new(0, 5, 0, 145)
Positions.Size = UDim2.new(1, -10, 0, 25)
Positions.Name = "Waypoints"
Positions.Parent = SettingsHolder

EventBind = makeSettingsButton("Edit Event Binds",getcustomasset("unlimitedadmin/assets/bindsandplugins.png"),759)
EventBind.Position = UDim2.new(0, 5, 0, 205)
EventBind.Size = UDim2.new(1, -10, 0, 25)
EventBind.Name = "EventBinds"
EventBind.Parent = SettingsHolder

Plugins = makeSettingsButton("Manage Plugins",getcustomasset("unlimitedadmin/assets/bindsandplugins.png"),743)
...
Notification.BackgroundColor3 = Color3.fromRGB(22, 24, 38)
...
do
	local _corner = Instance.new("UICorner")
	_corner.CornerRadius = UDim.new(0, 6)
	_corner.Parent = Notification
	local _stroke = Instance.new("UIStroke")
	_stroke.Color = Color3.fromRGB(80, 90, 160)
	_stroke.Thickness = 1
	_stroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
	_stroke.Parent = Notification
end

Title_2.Name = "Title"
Title_2.Parent = Notification
Title_2.BackgroundColor3 = Color3.fromRGB(55, 60, 140)
...
CloseImage.Image = getcustomasset("unlimitedadmin/assets/close.png")
...
PinImage.ZIndex = 10
PinImage.Image = getcustomasset("unlimitedadmin/assets/pin.png")

Tooltip.Name = randomString()
Tooltip.Parent = ScaledHolder
Tooltip.Active = true
Tooltip.BackgroundColor3 = Color3.fromRGB(22, 24, 38)
...
do
	local _corner = Instance.new("UICorner")
	_corner.CornerRadius = UDim.new(0, 5)
	_corner.Parent = Tooltip
	local _stroke = Instance.new("UIStroke")
	_stroke.Color = Color3.fromRGB(70, 80, 150)
	_stroke.Thickness = 1
	_stroke.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
	_stroke.Parent = Tooltip
end

Title_3.Name = "Title"
Title_3.Parent = Tooltip
Title_3.BackgroundColor3 = Color3.fromRGB(55, 60, 140)
Title_3.BackgroundTransparency = 0.05
...
IntroBackground.BackgroundColor3 = Color3.fromRGB(22, 24, 38)
...
Logo.Image = getcustomasset("unlimitedadmin/assets/logo.png")
...
Credits.Text = "Unlimited Admin | Based on IY by Edge // Zwolf // Moon // Toon // Peyton // ATP"
...
KeybindsFrame.BackgroundColor3 = Color3.fromRGB(22, 24, 38)
...
Close.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Add.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Delete.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Holder_2.ScrollBarImageColor3 = Color3.fromRGB(60, 65, 100)
...
Example_2.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Text_3.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Delete_2.BackgroundColor3 = Color3.fromRGB(60, 65, 100)
...
background_2.BackgroundColor3 = Color3.fromRGB(22, 24, 38)
...
Dark_3.Active = true
Dark_3.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
BindTo.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
BindTriggerSelect.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Add_2.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
ClickTP.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Select.BackgroundColor3 = Color3.fromRGB(60, 65, 100)
...
ClickDelete.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Select_2.BackgroundColor3 = Color3.fromRGB(60, 65, 100)
...
Cmdbar_2.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Cmdbar_3.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
CreateToggle.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Button_2.BackgroundColor3 = Color3.fromRGB(60, 65, 100)
...
On_2.BackgroundColor3 = Color3.fromRGB(100, 120, 220)
...
shadow_2.BackgroundColor3 = Color3.fromRGB(55, 60, 140)
...
ExitImage_2.Image = getcustomasset("unlimitedadmin/assets/close.png")

PositionsFrame.Name = "PositionsFrame"
PositionsFrame.Parent = Settings
PositionsFrame.Active = true
PositionsFrame.BackgroundColor3 = Color3.fromRGB(22, 24, 38)
...
Close_3.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Delete_5.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Part.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Holder_4.ScrollBarImageColor3 = Color3.fromRGB(60, 65, 100)
...
Example_4.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Text_5.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Delete_6.BackgroundColor3 = Color3.fromRGB(60, 65, 100)
...
TP.Name = "TP"
TP.Parent = Text_5
TP.BackgroundColor3 = Color3.fromRGB(60, 65, 100)
...
AliasesFrame.BackgroundColor3 = Color3.fromRGB(22, 24, 38)
...
Close_2.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Delete_3.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Holder_3.ScrollBarImageColor3 = Color3.fromRGB(60, 65, 100)
...
Example_3.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Text_4.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Delete_4.BackgroundColor3 = Color3.fromRGB(60, 65, 100)
...
PluginsFrame.BackgroundColor3 = Color3.fromRGB(22, 24, 38)
...
Close_4.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Add_3.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Holder_5.ScrollBarImageColor3 = Color3.fromRGB(60, 65, 100)
...
Example_5.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Text_6.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Delete_7.BackgroundColor3 = Color3.fromRGB(60, 65, 100)
...
background_3.BackgroundColor3 = Color3.fromRGB(22, 24, 38)
...
Dark_2.Active = true
Dark_2.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
Img.Image = getcustomasset("unlimitedadmin/assets/imgstudiopluginlogo.png")
Img.ZIndex = 10

AddPlugin.Name = "AddPlugin"
AddPlugin.Parent = background_3
AddPlugin.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
FileName.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
shadow_3.BackgroundColor3 = Color3.fromRGB(55, 60, 140)
...
ExitImage_3.Image = getcustomasset("unlimitedadmin/assets/close.png")
...
PluginsHint.Text = "Download plugins from the UA Discord (discord.gg/78ZuWSq)"
...
background_4.BackgroundColor3 = Color3.fromRGB(22, 24, 38)
...
ChoosePart.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
CopyPath.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
shadow_4.BackgroundColor3 = Color3.fromRGB(55, 60, 140)
...
PopupText_5.Font = Enum.Font.SourceSansBold
...
ExitImage_5.Image = getcustomasset("unlimitedadmin/assets/close.png")
...
ImageLabel.Image = getcustomasset("unlimitedadmin/assets/minimize.png")
...
ImageLabel_2.Image = getcustomasset("unlimitedadmin/assets/close.png")
...
eventEditor = (function()
	...
	local main = create({
		...
		{5,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image=getcustomasset("unlimitedadmin/assets/close.png"),Parent={4},Position=UDim2.new(0,5,0,5),Size=UDim2.new(0,10,0,10),ZIndex=10,}},
		...
		{53,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image=getcustomasset("unlimitedadmin/assets/settings.png"),Parent={52},Position=UDim2.new(0,2,0,2),Size=UDim2.new(0,16,0,16),ZIndex=10,}},
	})
	main.Name = randomString()
...
reference = (function()
	local main = create({
		...
		{114,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={112},Position=UDim2.new(0,8,0,30),Size=UDim2.new(1,-8,0,32),Text="You can join the Discord server to get support with UA,  and read up on more documentation such as the Plugin API.",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
...
currentShade1 = Color3.fromRGB(22, 24, 38)
currentShade2 = Color3.fromRGB(32, 35, 54)
currentShade3 = Color3.fromRGB(60, 65, 100)
currentText1 = Color3.new(1, 1, 1)
currentText2 = Color3.new(0, 0, 0)
currentScroll = Color3.fromRGB(80, 90, 150)
...
function createPopup(title, text)
	...
	background.Active = true
	background.BackgroundColor3 = Color3.fromRGB(22, 24, 38)
	background.BorderSizePixel = 0
	...
	shadow.Name = "shadow"
	shadow.Parent = Popup
	shadow.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
	shadow.BorderSizePixel = 0
	...
	ExitImage.Image = getcustomasset("unlimitedadmin/assets/close.png")
	ExitImage.ZIndex = 10
		...
		if readSuccess then
			if out ~= nil and tostring(out):gsub("%s", "") ~= "" then
				local success, response = pcall(function()
					...
					if vtype(json.keepUA, "boolean") then KeepUA = json.keepUA else KeepUA = true end
...
UAMouse.KeyDown:Connect(function(Key)
	if (Key==prefix) then
...
ColorsButton.MouseButton1Click:Connect(function()
	...
	if not colorpickerOpen then
		...
		Npicker.Default = function(self)
			updateColors(Color3.fromRGB(22, 24, 38),shade1)
			updateColors(Color3.fromRGB(32, 35, 54),shade2)
			updateColors(Color3.fromRGB(60, 65, 100),shade3)
			updateColors(Color3.new(1, 1, 1),text1)
			updateColors(Color3.new(0, 0, 0),text2)
			updateColors(Color3.fromRGB(60, 65, 100),scroll)
			wait()
			updatesaves()
		end
	else
...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			...
			local writelogs = '-- Unlimited Admin Chat logs for "'..placeName..'"\n'
			for _, child in pairs(scroll_2:GetChildren()) do
				writelogs = writelogs..'\n'..child.Text
			end
...
function selectPart()
	...
	local function HighlightPart()
		if selected.Adornee ~= UAMouse.Target then
			selectionBox.Adornee = UAMouse.Target
		else
			selectionBox.Adornee = nil
		end
	end
	ActivateHighlight = UAMouse.Move:Connect(HighlightPart)
	local function SelectPart()
		if UAMouse.Target ~= nil then
			selected.Adornee = UAMouse.Target
			Path.Text = getHierarchy(UAMouse.Target)
		end
	end
	ClickSelect = UAMouse.Button1Down:Connect(SelectPart)
end
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = 'Invite to the Unlimited Admin discord server.'}
...
CMDs[#CMDs + 1] = {NAME = 'hideua', DESC = 'Hides the main UA GUI'}
CMDs[#CMDs + 1] = {NAME = 'showua / unhideua', DESC = 'Shows UA again'}
CMDs[#CMDs + 1] = {NAME = 'keepua', DESC = 'Auto execute UA when you teleport through servers'}
CMDs[#CMDs + 1] = {NAME = 'unkeepua', DESC = 'Disable keepua'}
CMDs[#CMDs + 1] = {NAME = 'togglekeepua', DESC = 'Toggles keepua'}
...
function checkTT()
	local t
	local guisAtPosition = COREGUI:GetGuiObjectsAtPosition(UAMouse.X, UAMouse.Y)
	...
	if t ~= nil and t:GetAttribute("Title") ~= nil then
		...
		local xP
		local yP
		if UAMouse.X > 200 then
			xP = x - 201
		else
			xP = x + 21
		end
		if UAMouse.Y > (UAMouse.ViewSizeY-96) then
			yP = y - 97
		else
			yP = y
		end
			...
			if cmd then
				...
				if infTimes then
					while lastBreakTime < cmdStartTime do
						...
						if not success and _G.UA_DEBUG then
...
local MousePositionToVector2 = function()
	return Vector2.new(UAMouse.X, UAMouse.Y)
end
...
local function clicktpFunc()
	pcall(function()
		...
		local hitPosition = UAMouse.Hit.Position
...
UAMouse.Button1Down:Connect(function()
	for i,v in pairs(binds) do
		...
		elseif v.COMMAND == 'clickdel' then
			...
			if input == 'RightClick' and UserInputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton2) then
				pcall(function() UAMouse.Target:Destroy() end)
...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepUA and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeIY/unlimitedadmin/master/source'))()")
	end
end)
...
addcmd('keepua', {}, function(args, speaker)
	if queueteleport then
		KeepUA = true
		notify('KeepIY','Unlimited Admin will now run after you teleport')
		updatesaves()
	else
...
addcmd('unkeepua', {}, function(args, speaker)
	if queueteleport then
		KeepUA = false
		notify('KeepIY','Unlimited Admin will no longer run after you teleport')
		updatesaves()
	else
		notify('Incompatible Exploit','Your exploit does not support this command (missing queue_on_teleport)')
	end
...
addcmd('togglekeepua', {}, function(args, speaker)
	if queueteleport then
		KeepUA = not KeepUA
		updatesaves()
	else
...
addcmd('float', {'platform'},function(args, speaker)
	...
	if pchar and not pchar:FindFirstChild(floatName) then
		task.spawn(function()
			...
			qUp = UAMouse.KeyUp:Connect(function(KEY)
				if KEY == 'q' then
					FloatValue = FloatValue + 0.5
				end
			end)
			eUp = UAMouse.KeyUp:Connect(function(KEY)
				if KEY == 'e' then
					FloatValue = FloatValue - 1.5
				end
			end)
			qDown = UAMouse.KeyDown:Connect(function(KEY)
				if KEY == 'q' then
					FloatValue = FloatValue - 0.5
				end
			end)
			eDown = UAMouse.KeyDown:Connect(function(KEY)
				if KEY == 'e' then
					FloatValue = FloatValue + 1.5
				end
			end)
...
function deleteGuisAtPos()
	pcall(function()
		local guisAtPosition = PlayerGui:GetGuiObjectsAtPosition(UAMouse.X, UAMouse.Y)
		for _, gui in pairs(guisAtPosition) do
...
addcmd('hideua',{},function(args, speaker)
	isHidden = true
...
addcmd('showua',{'unhideua'},function(args, speaker)
	isHidden = false
	minimizeNum = -20
	if wasStayOpen then
		maximizeHolder()
...
addcmd('hovername',{},function(args, speaker)
	...
	nbUpdateFunc = UAMouse.Move:Connect(updateNameBox)
end)
...
if IsOnMobile then
	...
	QuickCapture.BackgroundColor3 = Color3.fromRGB(32, 35, 54)
...
task.spawn(function()
	local success, latestVersionInfo = pcall(function() 
		local versionJson = game:HttpGet("https://raw.githubusercontent.com/EdgeIY/unlimitedadmin/master/version")
